...
import sys
import time
from experiments.experiment_semseg import *
...
#%%
#%%
exp = SegmentationExperiment(hparams)
trainer = pl.Trainer(
    resume_from_checkpoint="./default_semseg/v_01/checkpoints/epoch=12-step=3717.ckpt",
    fast_dev_run=False,
    gpus=1,
